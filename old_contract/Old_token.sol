...
contract InitializableOwnable {
    ...
    modifier notInitialized() {
        require(!_INITIALIZED_, "LAPIS_INITIALIZED");
        _;
    }
...
// File: contracts/LAPISToken/LAPIS.sol


/**
 * @title LAPIS Contract on Celo
 */
contract LAPIS is InitializableOwnable {
    ...
    function redeem(uint256 value, address redeemToEthAccount) external {
        require(balances[msg.sender] >= value, "LAPIS: NOT_ENOUGH");
